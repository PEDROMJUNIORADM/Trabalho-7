...
//[]----------------------------------------------------[]	
	...
	{
		makeMatriz(file, &Mat, MatMatches, &tamColuna, &tamLinha, &qntdPalavras); // Chama a funcao makeMatriz que absorve os dados do arquivo de entrada
